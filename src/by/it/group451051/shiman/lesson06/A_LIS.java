...
public class A_LIS {
    ...
    int getSeqSize(InputStream stream) throws FileNotFoundException {
        ...
        int[] dp = new int[n]; // dp[i] - длина наибольшей возрастающей подпоследовательности, заканчивающейся в элементе i
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = 0; j < i; j++) {
                ...
                if (m[j] < m[i]) {
                    // Выбираем максимальную длину из всех возможных расширений
