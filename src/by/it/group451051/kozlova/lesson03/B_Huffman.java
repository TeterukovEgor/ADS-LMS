package by.it.group451051.kozlova.lesson03;
...
public class B_Huffman {
    ...
    String decode(File file) throws FileNotFoundException {
        ...
        for (int i = 0; i < encodedString.length(); i++) {
            ...
            if (codeMap.containsKey(currentCodeStr)) {
                result.append(codeMap.get(currentCodeStr));
