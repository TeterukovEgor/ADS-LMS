...
public class B_Sheduler {
    ...
    List<Event> calcStartTimes(Event[] events, int from, int to) {
        ...
        //ваше решение.
        //Надёжный шаг при работе с отрезками - ориентироваться на конец отрезка
        //Подключаем библиотеку java.util.Comparator, чтобы просортировать все эвенты по stop
